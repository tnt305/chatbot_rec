...
Please download DBpedia from the [link](https://databus.dbpedia.org/dbpedia/mappings) and make sure you download the bzip with **en** version, after unzipping, move it into `data/dbpedia`.
