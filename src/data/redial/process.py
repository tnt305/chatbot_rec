...
if __name__ == '__main__':
    ...
    process(f'{root_dir}/valid_data_dbpedia.jsonl', f'{root_dir}/valid_data_processed.jsonl', item_set)
    process(f'{root_dir}/test_data_dbpedia.jsonl', f'{root_dir}/test_data_processed.jsonl', item_set)
    process(f'{root_dir}/train_data_dbpedia.jsonl', f'{root_dir}/train_data_processed.jsonl', item_set)

    with open(f'{root_dir}/item_ids.json', 'w', encoding='utf-8') as f:
