...
def kg2id(kg):
    ...
    with open('/home/thiendc/InferConverRec/data/inspired/relation_set.json', encoding='utf-8') as f:
...
all_item = set()
file_list = [
    '/home/thiendc/InferConverRec/data/inspired/test.jsonl',
    '/home/thiendc/InferConverRec/data/inspired/dev.jsonl',
    '/home/thiendc/InferConverRec/data/inspired/train.jsonl',
]
