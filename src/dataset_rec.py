    ...
    def prepare_data(self, data_file):
        with open(data_file, 'r', encoding='utf-8') as f:
            ...
            for line in tqdm(lines):
                ...
                context_ids = context_ids[-min(self.context_max_length, 512):]
                ...
                prompt_ids = prompt_ids[-min(self.prompt_max_length, 256):]  # Truncate to last 256 tokens or prompt_max_length, whichever is smaller
